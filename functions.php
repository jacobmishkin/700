...
function _widgets_init() {
	...
	// Define sidebars.
	$sidebars = array(
		'sidebar-1'  => esc_html__( 'Sidebar 1', 'xyz' ),
		// 'sidebar-2'  => esc_html__( 'Sidebar 2', 'xyz' ),
		// 'sidebar-3'  => esc_html__( 'Sidebar 3', 'xyz' ),
	);
	...
	foreach ( $sidebars as $sidebar_id => $sidebar_name ) {
		register_sidebar( array(
			'name'          => $sidebar_name,
			'id'            => $sidebar_id,
			'description'   => /* translators: the sidebar name */ sprintf( esc_html__( 'Widget area for %s', 'xyz' ), $sidebar_name ),
