...
(function($){
    ...
    function previous_post_trigger() {
        ...
        var trigger_position = trigger.offset().top + 25 - $(window).outerHeight();
    ...
    function the_previous_post(object) {
        ...
        function build_post() {
            ...
            var previous_post_content =
                ...
                '</a>' +
                '<div class="ajax-loader"><img src="' + theme_uri + '/assets/images/svg-icons/spinner.svg" width="32" height="32" /></div>' +
                '</nav>';
