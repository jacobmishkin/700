...
function _font_url() {
	 ...
	 */
	$roboto = _x( 'on', 'Roboto font: on or off', 'xyz' );
	$open_sans = _x( 'on', 'Open Sans font: on or off', 'xyz' );
...
function _scripts() {
	...
	// Register styles.
	wp_register_style( 'xyz-google-font', _font_url(), array(), null );

	// Enqueue styles.
	wp_enqueue_style( 'xyz-google-font' );
	wp_enqueue_style( 'xyz-style', get_stylesheet_directory_uri() . '/style' . $suffix . '.css', array(), $version );
